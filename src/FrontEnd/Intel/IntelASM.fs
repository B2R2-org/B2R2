...
type ParseHelper (wordSize) =
  ...
  let initRegs =
    if WordSize.is32 wordSize then
      ...
      [ R.RAX; R.RBX; R.RCX; R.RDX; R.RSP; R.RBP; R.RSI; R.RDI; R.R8; R.R9; R.R10;
      R.R11; R.R12; R.R13; R.R14; R.R15; R.RIP; R.CS; R.DS; R.ES; R.FS; R.GS;
      R.SS; R.CSBase; R.DSBase; R.ESBase; R.FSBase; R.GSBase; R.SSBase; R.CR0;
      R.CR2; R.CR3; R.CR4; R.CR8; R.OF; R.DF; R.IF; R.TF; R.SF; R.ZF; R.AF; R.PF;
      R.CF; R.MM0;R.MM1; R.MM2; R.MM3; R.MM4; R.MM5; R.MM6; R.MM7; R.FCW; R.FSW;
      R.FTW; R.FOP; R.FIP; R.FCS; R.FDP; R.FDS; R.MXCSR; R.MXCSRMASK; R.PKRU;
  ...
  override __.RegNames =
    ...
    "CR0"; "CR2"; "CR3"; "CR4"; "CR8"; "OF"; "DF"; "IF"; "TF"; "SF"; "ZF"; "AF";
    "PF"; "CF"; "K0"; "K1"; "K2"; "K3"; "K4"; "K5"; "K6"; "K7" ]
  ...
  override __.InitStateRegs =
    initRegs |>
    List.map (fun regE ->
               (idOf regE, BitVector.ofInt32 0 (AST.typeOf regE)))
